 ...
 * ZsdkPlugin
 */
public class ZsdkPluginOld implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        if (DEBUG) {
            System.out.println("ZsdkPlugin registered with " + registrar.toString());
        }
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "zsdk");
        channel.setMethodCallHandler(new ZsdkPlugin(registrar));
    }

    private Context context;


    public ZsdkPluginOld(Registrar registrar) {
    ...
    private class DiscoveryRunner extends Thread implements DiscoveryHandler {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothDiscoverer.findPrinters(ZsdkPluginOld.this.context, this);
